...
- [x] Keep detailed editing, history, launch checks and provider evidence progressively disclosed.
- [x] Verify the new workspace across desktop and required mobile widths without weakening existing safety paths.
