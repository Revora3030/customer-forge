...
for (const p of ["cloudflare", "groq", "nvidia", "llm7", "openrouter", "google"] as const) {
...
await probe("llm7/primary", "llm7", "primary");
await probe("llm7/fast", "llm7", "fast");
await probe("llm7/coding", "llm7", "coding");
