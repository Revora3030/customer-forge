...
const context: AgentContext = {
  business: { name: "Test Business", industry: "cleaning", tagline: "Clean spaces", description: "Professional cleaning.", city: "Carrboro", state: "NC", serviceArea: "Triangle", phone: null, email: "test@example.com", services: [{ name: "Cleaning" }] },
  pages: [{
    ...
    sections: [
      { id: "hero", page_id: "home", kind: "hero", variant: "default", heading: "Clean spaces", subheading: null, body: null, settings: {}, sort_order: 0, is_visible: true, components: [
        { id: "image", section_id: "hero", kind: "image", label: null, body: null, media_url: "/cleaning.jpg", link_url: null, link_label: null, settings: {}, sort_order: 0, is_visible: true },
