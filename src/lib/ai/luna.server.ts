...
/**
 * The premium tiers are available whenever the key is present and no operator
 * switch turns them off. Spend stays bounded by the monthly cap, not by keeping
 * the tiers dark.
 */
